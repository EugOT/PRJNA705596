---
title: "Correlation analysis of Suprachiasmatic nucleus astrocytes dataset from Morris EL et al 2021"
...
DOCNAME <- "correlations-within-astrocytes-dataset-from-morris2021"
NOW <- Sys.time()
...
```{r params}
bioproject <- "PRJNA705596"
project <- "morris2021_SCN"
cb_fpr <- 0.001
low_cutoff_gene <- 500
...
high_cutoff_pc_hb <- 0.05
high_cutoff_doublet_score <- 0.33
high_cutoff_complexity <- 0.85
```

## Load selected astrocytes data from Morris EL et al 2021
...
plt_grp_ggcorrmat <- grouped_ggcorrmat(
  ...
  annotation.args = list(
    ...
    caption = "Dataset: subset of astrocytes from the Suprachiasmatic nucleus of the mouse hypothalamus (Morris EL et al 2021)"
  )
)
